...
const CalendarView: React.FC<CalendarViewProps> = ({ events, mode, currentDate, onDateClick, onEventClick }) => {
...
const InfiniteTimelineView = ({ currentDate, events, getEventsForDay, onDateClick, onEventClick }: any) => {
                                                ...
                                                >
                                                    {isToday && eIdx === 0 && (
                                                        <div className="flex items-center gap-2 mb-2 animate-pulse">
                                                            ...
                                                            <span className="text-red-500 text-[10px] font-bold uppercase tracking-widest">Now</span>
                                                        </div>
                                                    )}
