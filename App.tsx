        ...
        <div className="fixed inset-0 z-[100] flex items-end justify-center">
            ...
            <div className="relative bg-[#1C1C1E] w-full max-w-md rounded-t-3xl p-6 border-t border-white/10 shadow-2xl animate-in slide-in-from-bottom-full duration-300 pb-safe mb-0">
                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button onClick={() => setShowSettingsModal(false)} className="w-8 h-8 flex items-center justify-center rounded-full bg-neutral-800 text-neutral-400 hover:text-white transition-colors">
                        &times;
                    </button>
                </div>
                ...
                <div className="space-y-3">
                    ...
                    {/* Add Calendar */}
                    <button onClick={() => mockAction('Add Calendar feature coming soon!')} className="w-full flex items-center justify-between p-4 bg-neutral-900 rounded-2xl border border-neutral-800 hover:border-white/20 transition-all group">
                        <span className="font-medium text-neutral-300 group-hover:text-white">Add Another Calendar</span>
                        <PlusIcon className="w-5 h-5 text-neutral-500 group-hover:text-white" />
                    </button>

                    {/* Import/Export */}
                    <div className="grid grid-cols-2 gap-3">
                        <button onClick={() => mockAction('Importing...')} className="p-4 bg-neutral-900 rounded-2xl border border-neutral-800 hover:border-white/20 transition-all text-neutral-300 font-medium">
                            Import
                        </button>
                        <button onClick={() => mockAction('Exporting...')} className="p-4 bg-neutral-900 rounded-2xl border border-neutral-800 hover:border-white/20 transition-all text-neutral-300 font-medium">
                            Export
                        </button>
                    </div>
                    
                    <button 
                        onClick={() => { setSettings(s => ({...s, hasCompletedTour: false})); setShowSettingsModal(false); }} 
                    ...
                    >
                         <span className="font-medium text-neutral-300">Replay Tour</span>
